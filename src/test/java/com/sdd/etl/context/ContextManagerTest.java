...
public class ContextManagerTest {
    ...
    public void testCreateContext_NullConfig_ThrowsException() {
        ContextManager.createContext(DateUtils.parseDate("20250101"), null);
    }
    ...
    public void testCreateContext_InitializesCountersToZero() {
        ETLContext context = ContextManager.createContext(DateUtils.parseDate("20250101"), config);
    ...
    public void testSnapshot_ValidContext_ReturnsCopy() {
        ...
        assertEquals("Snapshot should contain date", DateUtils.parseDate("20250101"), snapshot.get(ContextConstants.CURRENT_DATE));
