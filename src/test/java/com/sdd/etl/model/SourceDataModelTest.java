...
/**
 * Unit tests for SourceDataModel abstract class.
 */
public class SourceDataModelTest {
    ...
    @Test
    public void testGetPrimaryKey_AbstractMethod_MustBeImplemented() {
        // Test is implemented in setUp() method
        Object result = model.getPrimaryKey();
        assertNotNull("Primary key should not be null", result);
    }

    @Test
    public void testGetSourceType_AbstractMethod_MustBeImplemented() {
        // Test is implemented in setUp() method
        String result = model.getSourceType();
        assertNotNull("Source type should not be null", result);
    }
}
