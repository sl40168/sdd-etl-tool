...
/**
 * Factory for creating {@link Extractor} instances based on source configuration.
 * <p>
 * This factory centralizes the creation logic for different types of extractors,
...
public class ExtractorFactory {
     ...
     * @throws ETLException if the source type is unsupported or configuration is invalid
     */
