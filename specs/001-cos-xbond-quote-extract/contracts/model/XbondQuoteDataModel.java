...
public class XbondQuoteDataModel extends SourceDataModel {
    ...
    public void setOfferOffer5YieldType(String offer5YieldType) { this.offer5YieldType = offer5YieldType; }
    ...
    public Map<String, String> getQuoteSummary() {
        ...
        if (bid0Price != null) summary.put("bid_0", bid0Price.toPlainString());
        if (offer0Price != null) summary.put("offer_0", offer0Price.toPlainString());
        if (bid1Price != null) summary.put("bid_1", bid1Price.toPlainString());
        if (offer1Price != null) summary.put("offer_1", offer1Price.toPlainString());
        if (bid2Price != null) summary.put("bid_2", bid2Price.toPlainString());
        if (offer2Price != null) summary.put("offer_2", offer2Price.toPlainString());
        if (bid3Price != null) summary.put("bid_3", bid3Price.toPlainString());
        if (offer3Price != null) summary.put("offer_3", offer3Price.toPlainString());
        if (bid4Price != null) summary.put("bid_4", bid4Price.toPlainString());
        if (offer4Price != null) summary.put("offer_4", offer4Price.toPlainString());
        if (bid5Price != null) summary.put("bid_5", bid5Price.toPlainString());
        if (offer5Price != null) summary.put("offer_5", offer5Price.toPlainString());
